...
const swarmStoreInitializer: StateCreator<SwarmStore> = (set) => ({
  ...
  applyIntegrity: undefined,
  researchIntegrity: undefined,
      ...
      cycleIntegrity:
        patch.cycleIntegrity === null
          ...
          : patch.cycleIntegrity !== undefined
            ...
            : s.cycleIntegrity,
      applyIntegrity:
        patch.applyIntegrity === null
          ? undefined
          : patch.applyIntegrity !== undefined
            ? patch.applyIntegrity
            : s.applyIntegrity,
      researchIntegrity:
        patch.researchIntegrity === null
          ? undefined
          : patch.researchIntegrity !== undefined
            ? patch.researchIntegrity
            : s.researchIntegrity,
      earlyStopDetail:
