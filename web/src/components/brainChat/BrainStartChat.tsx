...
import {
  BRAIN_TIP_MAX_WIDTH,
  BRAIN_TIP_SHOW_DELAY_MS,
  PROACTIVE_SUGGEST_PROMPT,
  RUN_CHAT_TIP,
  RUN_INPUT_TIP,
  RUN_SEND_TIP,
  RUN_SUGGEST_TIP,
  SETUP_AUTO_APPLY_TIP,
  SETUP_CHAT_TIP,
  SETUP_INPUT_TIP,
  SETUP_SEND_TIP,
} from "./tips";
import type { BrainConfigPatch, ChatMessage, RunBrainContext, RunReconfigPatch } from "./types";

export type { BrainConfigPatch, ChatMessage, RunBrainContext } from "./types";
export { buildRunContext, buildRunContextAsync, getChatContext } from "./buildRunContext";
