...
- The `glm-5.1:cloud` planner can take 60–180s for first prompt cold-start. The SSE-aware watchdog (commit `189ca05`) accepts this as long as SSE chunks are flowing.
