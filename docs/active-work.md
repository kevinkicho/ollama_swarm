...
**Still library-only (schema accepted):** bestOfNTurn, mentionContracts.

**Wired:** `councilReconcile: "judge" | "vote"`; `preflightDryRun`; `hunkRag`; `dynamicRolePicker` (round-robin dispositions).
