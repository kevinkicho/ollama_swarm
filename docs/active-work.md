...
**Still library-only (schema accepted):** bestOfNTurn, dynamicRolePicker, mentionContracts, preflightDryRun, hunkRag.

**Wired:** `councilReconcile: "judge" | "vote"` (synthesis + SetupForm; default remains revise+merge).
