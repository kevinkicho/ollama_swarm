 ...
 *  130 properties discovered across 11 contexts. */
...
/** Properties accessed by utilContext(). 15 properties. */export interface RunnerUtilFields {
  active: any;
  activeAborts: any;
  appendSystem: any;
  findings: any;
...
/** Properties accessed by workerContext(). 39 properties. */export interface WorkerFields {
  active: any;
  activeAborts: any;
  appendAgent: any;
  appendSystem: any;
